...
class OpenNIListener : public QObject {
  ...
  public:
    ...
    */
    ...
    // new functions for bag-Subscription
    // folder with trailing /
    bool runBagFile(const char* bagfile_folder, const char* bagfile_name);
    void restart_counting(){
     callback_counter =  cnt_added = cnt_irrelevant = cnt_failed = 0;
    }

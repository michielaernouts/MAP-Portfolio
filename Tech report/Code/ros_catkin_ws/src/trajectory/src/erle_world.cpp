...
int main(int argc, char **argv)
{
    ...
    //imu subscriber
    //ros::Subscriber imu_sub = n.subscribe<sensor_msgs::Imu>("erlecopter/imu",1000, chatterCallback);

           /* for(int i = 100; ros::ok() && i > 0; --i){
                msg_override.channels[3] = 1400; //override yaw channel to rotate
            ...
            for(int i = 100; ros::ok() && i > 0; --i){
                msg_override.channels[3] = 1500; //override yaw channel to stop rotation
                rc_override_pub.publish(msg_override);
                ros::spinOnce();
                r.sleep();
            }*/
